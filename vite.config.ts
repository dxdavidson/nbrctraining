...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      includeAssets: [
        'NBRC_Ergo_32.png',
        'NBRC_Ergo_squircle_180.png',
        'NBRC_Ergo_squircle_192.png',
        'NBRC_Ergo_squircle_512.png',
        'ergometer.js',
      ],
      manifest: {
        name: 'NBRC Training',
        ...
        icons: [
          {
            src: `${BASE_PATH}NBRC_Ergo_squircle_192.png`,
            sizes: '192x192',
            type: 'image/png',
            purpose: 'any',
          },
          {
            src: `${BASE_PATH}NBRC_Ergo_squircle_512.png`,
            sizes: '512x512',
            type: 'image/png',
